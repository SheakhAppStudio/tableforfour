            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-firstColor focus:ring-indigo-500 border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-firstColor hover:text-indigo-500">
                  Forgot password?
                </Link>
              </div>
            </div>
